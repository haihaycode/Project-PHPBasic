  ...
  $sql = "SELECT * FROM `product` WHERE userid = '" . $id . "' ORDER BY `id`";
  			...
  			<div class="row">
  				...
  				<div class="col-sm-9">
  					<div class="table-responsive cart_info">
  						<table class="table table-condensed" style="border: 1px solid wheat;">
  							<thead>
                      ...
                      <h3 style="color: #2B7CD3;">không có sản phẩm nào </h3>
  									...
  									foreach ($data as $value) {
  										?>
  										<tr style="border-top:1px solid #ff9b1917; ">
  											...
  											<td class="cart_price">
  												<a href=""><img width="80px" src ="<?php echo $value['image']; ?>" alt="null or erro"></a>
  											</td>
  											<td class="cart_description">
									...
									<td class="cart_description">
										...
										<a class="cart_quantity_delete" href="edit.php?idProduct=<?php echo  $value['id'];  ?>"><i class="fa fa-pencil-square" style="color: #428bca;font-size: 30px;" aria-hidden="true"></i></a>
										<a class="cart_quantity_delete" style="color: #428bca;font-size: 30px;" href="delete.php?idProduct=<?php echo  $value['id'];  ?>"><i class="fa fa-times"></i></a>
									</td>
								</tr>
