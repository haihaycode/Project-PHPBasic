...
if(isset($_POST['submit'])){
    ...
    if($x==1){
        ...
        if ($result=$con->query($sql)) {
            $mess= "Cập Nhật sản phẩm thành công Click vào <a href='my-product.php'>đây</a> để về trang my-product";
        }else{
                    ...
                    <div class="table-responsive cart_info">
                        ...
                        if(isset($_SESSION['id'])){
                           ...
                           <form method="POST" action="" class="my-form" enctype="multipart/form-data">
                            ...
                            <input type="text" name="title" placeholder="Nhập tên sản phẩm" value="<?php  echo $datas["title"];?>"> <br>
                            <p ><?php echo $err1; ?></p>
                            <input type="number" name="price" placeholder="Nhập giá tiền" value="<?php  echo $datas["price"];?>"> <br>
                            <p ><?php echo $err2; ?></p>
                            
                            <div class="mb-3">
                                <input class="form-control form-control-sm"  id="formFileSm" type="file" name="data"  > <br>
                                <img width="100px" src="<?php  echo $datas["image"];?>">
                            </div>
                            <br>
                            <br>
                            
                            <button type="submit" style="background-color: #FE980F;font-size: 20px; border: 0;"  name="submit">Cập Nhật Sản Phẩm</button>
                            <p style="color:  red; font-size: 20px;"><?php  echo $mess; ?></p>
